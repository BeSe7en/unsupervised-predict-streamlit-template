...
def main():
    ...
    if page_selection == "About Us":
        image = Image.open('resources/imgs/Predictive Insights.png')
        ...
        st.write('To access the codebase for this application, please visit the following GitHub repository:')
